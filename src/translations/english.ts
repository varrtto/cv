...
export const text: Translation = {
  ...
  education: {
    title: "Education",
    text: "Bachelor of Science in Computer Science (Expected 2025)",
  },
  certificates: {
    title: "Certificates",
    list: [
  ...
  references: {
    ...
    list: [
      {
        contact: "Rodrigo Falco / CTO and Co-founder @ Patagonian",
        phone: "+5492984737502",
      },
      {
        contact: "Ramiro Castro - Growth Product Manager @ Mural",
        phone: "+5493515087395",
      },
      {
        contact: "Matias Gea - Technical Lead @ Mural",
        phone: "+5492234227478",
      },
    ],
  },
  sidebar: {
    ...
    links: {
      title: "LINKS",
      github: "github.com/alfredogore",
      linkedin: "linkedin.com/in/alfredogore",
    },
    contact: {
      title: "CONTACT",
